...
| 01\_data\_profiling.sql | Checks record count, nulls, duplicates, and distributions |

| 02\_data\_quality\_checks.sql | Defines validation checks for invalid or missing data |

| 03\_kpi\_calculations.sql | Calculates business KPIs |

| 04\_risk\_analysis.sql | Creates risk bands and exposure flags |
...
| data\_quality\_rules.md | Documents validation rules |

| source\_to\_target\_mapping.md | Maps source fields to report fields |

| data\_lineage.md | Tracks metric flow from source to report |

| project\_summary.md | Summarizes the full project |
